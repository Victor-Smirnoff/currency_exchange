...
class GetPerformerCurrencies(GetPerformer):
    """
    Класс принимает в обработку GET запросы в таблицу Currencies на получение всех валют
    ...
    def __init__(self, path, command="GET"):
        """
        Инициализатор класса GetPerformerCurrencies
    ...
    def convert_query_data_currencies(self, column_names, query_data):
        """
        Метод получает список названий колонок и список кортежей с данными
        :param column_names: список названий колонок
        :param query_data: список кортежей с данными
        :return: данные в виде списка со словарями
        """
